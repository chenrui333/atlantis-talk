...
for i, slide in enumerate(slides, 1):
    ...
    elapsed = end
script += ['## Emergency 4-minute version', '', 'Use the same five slides. Skip exactly these sentences; do not speak faster. Keep the definition, full-plan review, configured approvals, security boundary, and final line.', '']
for i, slide in enumerate(slides, 1):
    for sentence in slide['emergency_skip']:
