...
const W=13.333333,H=7.5, M=.62; const notes=JSON.parse(fs.readFileSync('narration-expanded.json','utf8'));
...
await deck.writeFile({fileName:'slides-expanded.pptx'});
execFileSync('uv',['run','--with','defusedxml==0.7.1','python','apply-template.py','slides-expanded.pptx','narration-expanded.json'],{stdio:'inherit'});
